...
public class TowersOfHanoi {
    ...
    public void solve(int disk, char source, char middle, char destination) {
        ...
        //we call this method recursively so this is no always the largest plate !!!
        System.out.println("Plate " + disk + " from " + source + " to " + destination);
        // we move n-1 plates from the middle o the destination(with the help of the first rod)
